...
function peg$parse(input, options) {
  ...
  var peg$f85 = function(id1, method, exp) {return exp};
  var peg$f86 = function(id1, method, exp) {return crearNodo('arrayFunc', { id: crearNodo('referenciaVariable', { id:id1 }), method, exp })};
  var peg$f87 = function(id1, index, value) {return crearNodo('arrayFunc', { id:crearNodo('referenciaVariable', { id:id1 }), method:'setElement', exp:[index, value]});};
  ...
  var peg$f92 = function(id1, index) {const value = null; return crearNodo('arrayFunc', { id:crearNodo('referenciaVariable', { id:id1 }), method:'getElement', exp:[index,value]});};
